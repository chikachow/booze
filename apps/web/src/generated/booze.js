...
/**
 * booze theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { boozeTheme } from './booze';
 *   import './booze.css';
 */
export const boozeTheme = {
  name: 'booze',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FFFBFC, #25181B)",
    "--color-background-body": "light-dark(#FFECF0, #1B0D10)",
    "--color-background-card": "light-dark(#FFFBFC, #25181B)",
    "--color-background-popover": "light-dark(#FFFBFC, #3B2D30)",
    "--color-background-muted": "light-dark(#25181B0D, #25181B80)",
    "--color-accent": "light-dark(#A43659, #FFB0C2)",
    ...
    "--color-overlay-hover": "light-dark(#25181B0D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#25181B1A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#25181B, #F1DEE1)",
    "--color-text-secondary": "light-dark(#564146, #C6ADB2)",
    "--color-text-disabled": "light-dark(#A38B8F, #6F595D)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #6B002C)",
    ...
    "--color-icon-primary": "light-dark(#25181B, #F1DEE1)",
    "--color-icon-secondary": "light-dark(#564146, #BEA5AA)",
    ...
    "--color-border": "light-dark(#25181B1A, #FFECF01A)",
    "--color-border-emphasized": "light-dark(#BEA5AA, #564146)",
    "--color-skeleton": "light-dark(#BEA5AA, #564146)",
    ...
    "--color-background-inverted": "light-dark(#25181B, #FFFBFC)",
    "--color-track": "light-dark(#BEA5AA, #564146)",
    "--radius-chat": "28px"
  },
